...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/OutputCacheDallESample.bicep](./infra/app/OutputCacheDallESample.bicep)
...
- [app/OutputCacheDallESample.bicep](./infra/app/OutputCacheDallESample.bicep) - Azure Container Apps resources to host the 'OutputCacheDallESample' service.
